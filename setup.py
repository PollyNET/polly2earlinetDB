...
setup(name='polly_2_earlinet_convertor',
      packages=['polly_2_earlinet_convertor'],
      version=find_version("src", "__init__.py"),
      description='Package for converting the polly profiles from labview program to EARLINET format nc files through command line.',
      ...
      entry_points={
          'console_scripts': ['p2e_go = src:polly_2_earlinet_convertor:main'],
      },
      )
